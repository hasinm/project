...
<a class="dropdown-toggle" data-toggle="dropdown" style = "color:white;" href="{{url('gadgets')}}">#Gadgets<span class="caret"></span></a>
<ul class="dropdown-menu">
            <li><h4 style="color:white;">&emsp;Type:</h4></li>
            <li><a href="{{url('laptop')}}">PC/Laptops</a></li>
            ...
            <li><a href="{{url('ascend')}}">Low to High</a></li>
            <li><a href="{{url('descend')}}">High to Low</a></li>
          </ul>  
      </ul>
</div>
...
document.getElementById("mySidenav").style.width = "0";
            ...
            <div class="col-lg-12">
            <h2 style="text-align:center;font-family:Raleway;"><u>G A D G E T S</u></h2>
            </div>
            ...
            <br><img src="{{asset('uploads/'.$prod_data->product_image)}}"  width="200" height="230">
            </a>
