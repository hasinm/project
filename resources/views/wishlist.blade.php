...
document.getElementById("mySidenav").style.width = "0";
            ...
            <td>&emsp;<a href="{{url('/home') }}"> Home</a></td>
            ...
            <div class="col-lg-12">
            <h2 style="text-align:center;font-family:Raleway;"><u>W I S H L I S T</u></h2>
            </div>
            @foreach($product ?? '' as $prod_data) 
            <div class="col-lg-3 col-md-4 col-sm-6">
            <a href="{{URL::to('sum/'.$prod_data->id)}}">
            <br><p>Name: {{$prod_data->product_name}}</p>
            <p>Price: {{$prod_data->product_price}}</p></a>
      ...
      <center><button class="btn btn-success align-center"><a href="{{url('wshlcln')}}" style="color:yellow;">Clear Wishlist</button></a><center>
      </div>
    </body>
</html>