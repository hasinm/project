...
<ul><a class="dropdown-toggle" data-toggle="dropdown" style = "color:white;" href="{{url('fsnproducts')}}">#Fashion<span class="caret"></span></a>
<ul class="dropdown-menu">
            <li><h4 style="color:white;">&emsp;Type:</h4></li>
            <li><a href="{{url('tees')}}">T-Shirt</a></li>
            <li><a href="{{url('jacket')}}">Jacket</a></li>
            <li><a href="{{url('shirt')}}">Shirt</a></li>
            <li><h4 style="color:white;">&emsp;Price:</h4></li>
            <li><a href="{{url('lth')}}">Low to High</a></li>
            <li><a href="{{url('htl')}}">High to Low</a></li>
          </ul>
...
document.getElementById("mySidenav").style.width = "0";
            ...
            <div class="col-lg-12">
            <h2 style="text-align:center;font-family:Raleway;"><u>F A S H I O N </u></h2>
            </div>
            ...
            <a href="{{URL::to('cloth/'.$prod_data->id)}}" >
            
            <img src="{{asset('uploads/'.$prod_data->product_image)}}"  width="304" height="236">
            </a>
