...
document.getElementById("mySidenav").style.width = "0";
            ...
            <div class="col-lg-12">
            <h2 style="text-align:center;font-family:Raleway;"><u>A L L&emsp;P R O D U C T S</u></h2>
            </div>
            ...
            <button class="btn btn-primary align-center"><a href="{{URL::to('add_tocart/'.$prod_data->id)}}" style="color:navy;">Add to Cart</a></button>
            <br><br>
          </div>
